...
public class Controller_Fattura implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()== jframe_fattura.getjButton1())jButton1ActionPerformed();
		else if(e.getSource()== jframe_fattura.getjButton_Back_Fattura())jButton_Back_FatturaActionPerformed();
		else if(e.getSource()== jframe_fattura.getjButton_Home_Fattura())jButton_Home_FatturaActionPerformed();
	}
