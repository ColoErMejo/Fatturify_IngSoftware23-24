...
public class Controller_Personale implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if( e.getSource() == jframe_personale.getjButton_AddPersonale())jButton_AddPersonaleActionPerformed();
		else if(e.getSource() == jframe_personale.getjButton_Back_Pers())jButton_Back_PersActionPerformed();
		else if(e.getSource() == jframe_personale.getjButton_EliminaPersonale())jButton_EliminaPersonaleActionPerformed();
		else if(e.getSource() == jframe_personale.getjButton_Home_Pers())jButton_Home_PersActionPerformed();
		else if(e.getSource() == jframe_personale.getjButton_ModificaPersonale())jButton_ModificaPersonaleActionPerformed();
