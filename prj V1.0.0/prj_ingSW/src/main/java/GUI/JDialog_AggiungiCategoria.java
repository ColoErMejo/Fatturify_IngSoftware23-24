...
public class JDialog_AggiungiCategoria extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_AggiungiCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog_AggiungiCategoria dialog = new JDialog_AggiungiCategoria(new javax.swing.JFrame(), true);
