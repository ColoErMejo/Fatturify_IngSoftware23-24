...
public class JDialog_EliminaProdotto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton_Elimina_Prod_POP = new javax.swing.JButton();
        ...
        jPanel2.add(jLabel_Prezzo_POP, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, -1, 30));
        ...
        jPanel1.add(jComboBox_Prodotto_POP, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 190, -1));

        jButton_Elimina_Prod_POP.setBackground(new java.awt.Color(255, 255, 255));
        jButton_Elimina_Prod_POP.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        jButton_Elimina_Prod_POP.setForeground(new java.awt.Color(51, 51, 51));
        jButton_Elimina_Prod_POP.setText("Elimina");
        jButton_Elimina_Prod_POP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_Elimina_Prod_POPActionPerformed(evt);
            }
        });
        jPanel1.add(jButton_Elimina_Prod_POP, new org.netbeans.lib.awtextra.AbsoluteConstraints(265, 250, 100, -1));
        ...
        jLabel_Modifica_Prodotto_POP.setText("Elimina Prodotto");
    ...
    private void jButton_Elimina_Prod_POPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Elimina_Prod_POPActionPerformed
        dispose();
    }//GEN-LAST:event_jButton_Elimina_Prod_POPActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog_EliminaProdotto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
